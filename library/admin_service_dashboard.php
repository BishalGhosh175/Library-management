    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div class="leftinnerdiv">
                ...
                <Button class="greenbtn" onclick="openpart('studentrecord')"> <img class="icons" src="images/icon/monitoring.png" width="30px" height="30px"/> MEMBER REPORT</Button>
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>OTHER<input type="radio" name="branch" value="BBA"/>BBA<div style="margin-left:80px"><input type="radio" name="branch" value="MCA"/>MCA<input type="radio" name="branch" value="Bca"/>BCA</div>
            </div>   
            ...
            <label>Library_id:</label><input type="pasword" name="addpass"/>
            </br>
            ...
            $table="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'><tr><th style=' 
            padding: 8px;'> Name</th><th>Email</th><th>Type</th><th>Operations</th>,<tr>";
            foreach($recordset as $row){
                $table.="<tr>";
               "<td>$row[0]</td>";
                $table.="<td>$row[1]</td>";
